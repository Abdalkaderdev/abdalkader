      ...
      const response = await executeAIRequest(
        async (prompt: string) => {
          ...
          const aiResponse = await secureAIClient.chat({
            message: prompt,
            context: 'You are an expert programming language historian. Transform modern code to historical programming styles, explaining the changes and historical context.',
          });
