...
export const ECOSYSTEM_DOMAINS: EcosystemDomain[] = [
  ...
  },
  {
    ...
    color: '#3b82f6',
    status: 'active',
    features: ['Guides', 'API Docs', 'Tutorials', 'Reference'],
  ...
  },
  {
    ...
    subdomain: 'quantumanim',
    domain: 'abdalkader.dev',
    description: 'Advanced animation library and interactive demos',
    icon: '⚡',
    color: '#8b5cf6',
    status: 'active',
    features: ['Animations', 'Interactions', 'Demos', 'Library'],
    lastUpdated: '2024-01-15',
    analytics: {
      visitors: 1800,
      pageViews: 4500,
