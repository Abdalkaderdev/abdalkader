...
export default function ContactSection() {
    ...
    return (
        <>
            ...
            {/* Contact Form Section - Prominently displayed */}
            ...
            {/* Social Links - Secondary contact options with semantic address element */}
            <section className={styles.linkSection} ref={socialSectionRef}>
                <div className={styles.socialHeader}>
                    <p>Or connect with me on</p>
                </div>
                <address className={styles.wrapper} itemScope itemType="https://schema.org/Person">
                    <meta itemProp="name" content="Abdalkader Alhamoud" />
                    <Link
                        href="mailto:hello@abdalkader.dev"
                        className={styles.socialLink}
                        itemProp="email"
                        aria-label="Send email to hello@abdalkader.dev"
                    >
                    ...
                    <Link
                        href="https://www.instagram.com/abdalkader.dev"
                        target="_blank"
                        rel="noopener noreferrer"
                        className={styles.socialLink}
                        itemProp="sameAs"
                        aria-label="View Instagram profile (opens in new tab)"
                    >
                        <span className={styles.icon} aria-hidden="true">
                            <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
